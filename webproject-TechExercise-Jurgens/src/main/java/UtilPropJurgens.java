...
public class UtilPropJurgens {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\jurge\\Downloads\\4830\\workspace4830\\workspace4830-TechExercise-Jurgens\\webproject-TechExercise-Jurgens\\src\\main\\webapp\\WEB-INF\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat9/webapps/webproject-TechExercise-Jurgens/WEB-INF/config.properties";
